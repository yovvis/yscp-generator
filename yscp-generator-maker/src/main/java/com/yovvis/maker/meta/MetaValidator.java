...
import com.yovvis.maker.meta.enums.ModelTypeEnum;
...
public class MetaValidator {
    ...
    public static void validAndFillMetaRoot(Meta meta) {
        ...
        String author = StrUtil.emptyToDefault(meta.getAuthor(), "yovvis");
        String basePackage = StrUtil.blankToDefault(meta.getBasePackage(), "com.yovvis");
